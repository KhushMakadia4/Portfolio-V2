...
const SocialsTray = () => {
  const socials: {
    ...
    },
    {
      ...
      link: "mailto:kmakcareer@gmail.com"
    }
  ]

  return (
    <div className="flex md:order-first order-last md:flex-col md:space-x-0 md:space-y-3 md:w-max md:p-2 bg-zinc-800 h-max w-max rounded-lg space-x-3 p-1">
      {socials.map((social, i) => {
        return (
          <Link href={social.link} key={`${i}-${social.link}`} legacyBehavior>
